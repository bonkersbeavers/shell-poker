package core.hand
//
//import core.hand.action.betting.ActionType
//import core.cards.Card
//import core.cards.CardRank
//import core.cards.CardSuit
//import core.hand.action.dealer.BettingRound
...
//        val playerWithoutCards = Player(seat = 0, stack = 100)
...
//                        Player(seat = 0, stack = 100, currentBet = 0, currentActionType = null),
//                        Player(seat = 1, stack = 100, currentBet = 50, currentActionType = ActionType.POST),
//                        Player(seat = 2, stack = 100, currentBet = 100, currentActionType = ActionType.POST)
//                ),
//                lastLegalBet = 100
//        )
//        assert(noAggressorState.lastAggressor == null)
//
//        val aggressor1 = Player(seat = 0, stack = 100, currentBet = 200, currentActionType = ActionType.BET)
...
//
//        val aggressor2 = Player(seat = 1, stack = 100, currentBet = 500, currentActionType = ActionType.RAISE)
//        val aggressorState2 = baseState.copy(
//                playersStates = listOf(
//                        Player(seat = 0, stack = 100, currentBet = 200, currentActionType = ActionType.BET),
//                        aggressor2,
//                        Player(seat = 2, stack = 100, currentBet = 0, currentActionType = ActionType.CHECK)
//                ),
//                lastLegalBet = 500
//        )
