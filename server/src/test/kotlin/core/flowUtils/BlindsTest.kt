...
class BlindsTest {
    ...
    fun `postBlindsAndAnte method should update players and handState`() {
        val player0 = Player(seat = 0, stack = 1000) // dealer
        val player1 = Player(seat = 1, stack = 1000) // small blind
        val player2 = Player(seat = 2, stack = 1000) // big blind
    ...
    fun `postBlindsAndAnte method should properly process players with not enough chips in the stack`() {
        val player0 = Player(seat = 0, stack = 150) // dealer
        val player1 = Player(seat = 1, stack = 300) // small blind
        val player2 = Player(seat = 2, stack = 275) // big blind
    ...
    fun `postBlindsAndAnte method should force big blind post from the players that are new at the table`() {
        val player0 = Player(seat = 0, stack = 1000) // dealer
        val player1 = Player(seat = 1, stack = 1000) // small blind / new player
        val player2 = Player(seat = 2, stack = 1000) // big blind
        val player3 = Player(seat = 3, stack = 1000) // new player
